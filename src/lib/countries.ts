/**
 * ISO 3166-1 alpha-2 codes with Ukrainian names, for the client-profile
 * country <select>. Ukraine and Estonia listed first (the two markets
 * intech.org.ua actually operates in), then the rest alphabetically by
 * Ukrainian name.
 */
