...
export const ui = {
	uk: {
		...
		'contact.phoneUaLabel': 'Телефон (Україна)',
		'contact.phoneEeLabel': 'Телефон (Естонія)',
	...
	en: {
		...
		'contact.phoneUaLabel': 'Phone (Ukraine)',
		'contact.phoneEeLabel': 'Phone (Estonia)',
	...
	et: {
		...
		'contact.phoneUaLabel': 'Telefon (Ukraina)',
		'contact.phoneEeLabel': 'Telefon (Eesti)',
